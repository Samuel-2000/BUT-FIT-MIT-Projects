...
int main(int argc, char **argv)
{
  ...
  */
// Fill the memory descriptor layout for hParticles
  ...
  CUDA_CALL(cudaMemset(dTmpVelocities.x, 0, N * sizeof(float)));  // std::numeric_limits<float>::min()?
  ...
  /********************************************************************************************************************/
  // Copy particle data from host (pinned) to device
